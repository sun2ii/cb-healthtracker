...
export default function ElderHomePage() {
  ...
  useEffect(() => {
    const hasSeenOnboarding = localStorage.getItem('demo-onboarding-complete');
  ...
  return (
    <div className="flex flex-col gap-4 pt-4">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div data-onboarding="checkin" className={`rounded-xl p-4 flex items-center ${!todayCheckIn ? 'bg-gradient-to-br from-[#4a9d94] to-[#3d8a82]' : 'bg-white border border-gray-100 shadow-sm'}`}>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div data-onboarding="streak" className="bg-white rounded-xl p-3 border border-gray-100 shadow-sm flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {/* Medications */}
          <div data-onboarding="medications" className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-semibold text-gray-900 text-sm">Medications</h3>
              <Link href="/demo/medications" className="text-[#4a9d94] text-xs font-medium">
          ...
          {/* Activity */}
          <div data-onboarding="activity" className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-semibold text-gray-900 text-sm">Activity</h3>
              <Link href="/demo/activity" className="text-[#4a9d94] text-xs font-medium">View</Link>
            </div>
            {todayCheckIn ? (
      ...
      <div data-onboarding="appointments" className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
      ...
      <div className="hidden md:flex gap-2">
        <Link href="/demo/medications/add" className="flex-1">
        ...
        <Link href="/demo/activity" className="flex-1">
        ...
        <Link href="/demo/profile" className="flex-1">
      ...
      <div className="text-center pt-2 pb-4">
        <button
          ...
          className="text-xs text-gray-400 hover:text-[#4a9d94] transition-colors"
        >
